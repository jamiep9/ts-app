...
export const HomeContent: React.FC = () => {
    ...
    return (
        ...
        <div className='profileImageDiv' style={{marginTop: '50px'}}>
            <Row gutter={50}>
                <Col xs={22} sm={22} md={20} lg={8} xl={8} className='gutter-row'>
                    <Image
                        src={profilePic}
                ...
                <Col xs={22} sm={22} md={20} lg={16} xl={16} className='gutter-row'>
        ...
        <div className='skillsDiv'>
            <Row gutter={50}>
                ...
                <Col xs={22} sm={22} md={16} lg={16} xl={12} className='gutter-row'>
